...
describe('Register user web controller', () => {
  ...
  test('should return status code 400 when request cis missing user name', async () => {
    const requestWithInvalidName: HttpRequest = {
      body: {
        email: 'any@mail.com'
      }
  ...
  test('should return status code 400 when request cis missing user email', async () => {
    const requestWithInvalidName: HttpRequest = {
      body: {
        name: 'Any name'
      }
